...
//	  System.out.println(leftpanelcategories.size());
	  Random r = new Random();
	  ...
	  // Adding 3 different items to the basket
...
//		System.out.println(availableItems.size());
		if (availableItems.size() > 0) {
			...
			//System.out.println("Selected items is"+"  "+availableItems.get(selectItem).getText());
		} else {
...
//	  System.out.println(itemsQuantity.size());
	  log.debug("Adding items to basket!");
